...
The process of transforming wide to long format and data cleaning can be accessed [here](https://github.com/AnhKhoaVo/Lumbar-Disc) 
...
```{r, barplot last, fig.keep='all', fig.height = 8, fig.width = 15, fig.align = "center"}
